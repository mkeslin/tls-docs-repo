...
Welcome to the 3.13.0 release of Thin Line RMS/CAD. There are a number of updates in this version that we hope you like.
...
- Updated mobile citation format
- Added mobile citation support for driver license and vehicle registration scanning (with barcode scanner)
