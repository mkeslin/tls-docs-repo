...
Welcome to the 5.4.0 release of Thin Line RMS/CAD. There are a number of updates in this version that we hope you like.
...
- Added notes to master records
- Refactored audit logic to improve performance
- Added Code Enforcement module
