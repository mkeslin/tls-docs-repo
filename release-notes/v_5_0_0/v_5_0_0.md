...
Welcome to the 5.0.0 release of Thin Line RMS/CAD. There are a number of updates in this version that we hope you like.
...
- Switched authentication service to Descope
- Updated admin user management for Descope
- Updated user profile for Descope
- Added support chat integration
