...
Every SOP should follow this structure. Do not invent undocumented process detail — use `TODO:` or `Decision needed:` markers.
...
| 2 | [Deliver — Bootstrap Environment](deliver/bootstrap-environment.md) | Placeholder |
| 3 | [Deliver — Customer Onboarding](deliver/customer-onboarding.md) | Placeholder |
