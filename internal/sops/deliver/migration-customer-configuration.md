...
| Document | Role |
|----------|------|
| [Migration Package Standards](migration-package-standards.md) | Package side of the equation |
| [Vendor Conversion Guides](vendor-conversion-guides/README.md) | Per-vendor checklist / extract notes |
