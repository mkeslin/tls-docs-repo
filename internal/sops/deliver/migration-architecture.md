...
| **Package** | Choose / extend vendor Migration Package | [Migration Package Standards](migration-package-standards.md) · [Vendor Guides](vendor-conversion-guides/README.md) |
...
Environment provisioning: [Bootstrap Environment](bootstrap-environment.md). Broader onboarding: [Customer Onboarding](customer-onboarding.md) *(placeholder)*.
