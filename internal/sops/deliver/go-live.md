...
Cut over to Thin Line as the system of record for agreed modules—customer is **live** in production.
...
1. Go / no-go review.  
2. Execute cutover (DNS, exclusive use, legacy freeze as planned).  
...
- Production exclusive use (per scope)  
- Go-live announcement / notes  
- Hypercare start  
...
- [ ] Go-live readiness criteria met or waived with approval  
