...
|:-:|-------|----------|--------|
| 0 | Sales handoff | [Sales handoff](sales-handoff.md) | Placeholder |
| 1 | Kickoff and discovery | [Kickoff and discovery](kickoff-and-discovery.md) | Placeholder |
| 2 | Infrastructure | [Infrastructure](infrastructure/README.md) | v1 |
| 3 | Data migration | [Data migration](data-migration/README.md) | v1 |
...
| [Configuration discovery workbook](../../../customer/implementation/configuration-discovery-workbook.md) | Customer template |
...
| Doc | Type |
|-----|------|
| [Operate](../operate.md) | Next stream stage (stub) |
...
## Customer-facing implementation pack

Shared with the agency (no internal SOPs or pricing):
...
- [Legacy onboarding questionnaire mapping](legacy-onboarding-questionnaire-mapping.md)
