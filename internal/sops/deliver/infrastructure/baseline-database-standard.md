...
Defines the **seed databases** used when bootstrapping a new agency environment. Separate from the [Bootstrap Environment SOP](bootstrap-environment.md) (which imports them) and from [Legacy System Migration](../data-migration/legacy-system-migration.md) (which loads customer history).
