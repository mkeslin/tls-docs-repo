...
**Phase:** Deliver  
**Status:** v1 form  
**Related SOP:** [Legacy System Migration](../sops/deliver/legacy-system-migration.md)
...
| **Prepared by** | |
| **Legacy platform** | |
| **Migration complexity** | Low / Medium / High / **TODO:** |
...
> **Hard stop:** Do not access legacy data until both are complete. See [Legacy System Migration SOP — Trigger](../sops/deliver/legacy-system-migration.md#4-trigger).
...
> **TODO:** Link each assessment to a Converter Registry entry when that registry exists.
...
| Expected acquisition timing | ☐ Before go-live · ☐ Backfill after go-live · ☐ TBD |
...
|----------|--------|-------|
| UAT required? | ☐ Yes · ☐ No · ☐ TBD | |
| Production direct? | ☐ Yes · ☐ No · ☐ TBD | |
| Backfill after go-live? | ☐ Yes · ☐ No · ☐ TBD | |
| Parallel validation? | ☐ Yes · ☐ No · ☐ TBD | |
| Freeze legacy system? | ☐ Yes · ☐ No · ☐ TBD | |
...
| Field | Value |
|-------|-------|
| Migration tier | ☐ Tier 1 · ☐ Tier 2 · ☐ Tier 3 · ☐ Tier 4 Custom · ☐ Bundled with multi-year SaaS · ☐ TBD |
| Estimated hours | |
| Recommended price | |
| Reasoning | |
...
**TODO:** Rank automation of assessment generation on the product / internal tooling roadmap.
