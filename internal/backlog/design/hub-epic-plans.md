...
- Why now: Home Plans + `SalesPlanPeriod.Epic` already surface every epic; Acquire through Advocate have dedicated desks (Internal next).
- Related design: [Hub Acquire Desk](hub-acquire-desk.md), [Hub notecard board](hub-notecard-board.md), [Hub Deliver Desk](hub-deliver-desk.md), [Hub Operate Desk](hub-operate-desk.md), [Hub Expand Desk](hub-expand-desk.md), [Hub Advocate Desk](hub-advocate-desk.md), [Hub Internal Desk](hub-internal-desk.md)
- Related templates: [Two-week sales plan](../../templates/sales-plan-two-week.md), [Two-week deliver plan](../../templates/deliver-plan-two-week.md), [Two-week operate plan](../../templates/operate-plan-two-week.md), [Two-week expand plan](../../templates/expand-plan-two-week.md), [Two-week advocate plan](../../templates/advocate-plan-two-week.md), [Two-week internal plan](../../templates/internal-plan-two-week.md)
...
4. **Plans vs desks** — A **plan** is the two-week coaching artifact on Home. A **desk** is a dedicated route for that epic’s plan (and optional catalog tools). Acquire keeps `/acquire` (plan + playbooks + email). Deliver, Operate, Expand, and Advocate are plan-only desks in v0.1 (`/deliver`, `/operate`, `/expand`, `/advocate`). Internal stays Home Plans until a desk design expands it.
5. **SoR split by epic** — Plans are never the engagement CRM or project workspace:
   ...
   - Advocate: Pipedrive origin + org notes remain referral/reference SoR ([Advocate Desk](hub-advocate-desk.md)); plan is owner execution only.
   - Internal: payroll / HR / CJIS tools remain ops SoR ([Internal Desk](hub-internal-desk.md)); plan is owner execution only.
   - Internal: follow company-ops process; do not invent Hub SoRs in v0.1.
