...
- Why now: Home Plans + `SalesPlanPeriod.Epic` already surface every epic; only Acquire has a rich blank template and a dedicated desk.
- Related design: [Hub Acquire Desk](hub-acquire-desk.md), [Hub notecard board](hub-notecard-board.md), [Hub Deliver Desk](hub-deliver-desk.md)
- Related templates: [Two-week sales plan](../../templates/sales-plan-two-week.md), [Two-week deliver plan](../../templates/deliver-plan-two-week.md)
