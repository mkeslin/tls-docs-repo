# Data conversion ? Customer Data Migrated

**Phase:** Deliver  
**Desired outcome:** Customer Data Migrated (historical data in Thin Line, validated and accepted)

> **Naming:** This CVE stage was historically called “Data conversion.” The implementation milestone is **[Customer Data Migrated](../../sops/deliver/data-migration/README.md)**—broader than running scripts (assessment, packages, validation, acceptance, versioning).
...
**Milestone overview:** [Customer Data Migrated](../../sops/deliver/data-migration/README.md)  
...
- [Customer Data Migrated (phase overview)](../../sops/deliver/data-migration/README.md)
