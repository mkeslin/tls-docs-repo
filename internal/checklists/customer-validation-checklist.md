...
**Status:** v1  
**Referenced by:** [Legacy System Migration](../sops/deliver/legacy-system-migration.md) (Phase 8) · [Migration Validation Standard](../sops/deliver/migration-validation-standard.md) (Layer C)
...
- [ ] [Migration Validation Standard](../sops/deliver/migration-validation-standard.md) Layers A–B complete for agreed scope  
- [ ] [Post-Conversion Utilities](../sops/deliver/post-conversion-utilities.md) run where required  
