...
Record the stop / violation **location** using the fields on General and/or Person & Vehicle (layout depends on your build). Accurate location helps reports, court packets, and later RMS analysis.
