# Court clerk workshop

**Audience:** Court clerks, cashiers, court administrators  
**Goal:** Process a court violation from intake-style activation through common docket, payment, and queue work  
**Typical length:** ~3–4 hours (half day)  
**Environment:** Training tenant with sample court violations  

## Prerequisites

- [New user orientation](new-user-orientation.md) completed (or equivalent)
- Court Violation module access
- Sample citations / violations in the training agency
...
| Reports (overview) | 15 | [Reports](../court/reports.md) · [Documents and forms](../court/documents.md) | Open **Reports** (including **Open Violations**, **Appeals**, and **Pre-Trials**, plus OCA / DPS / State Quarterly **preview** cards) and **Reporting Status**; name OCA / DPS packs your agency will file; open one case Documents grid |
