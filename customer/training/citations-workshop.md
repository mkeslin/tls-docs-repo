...
- [New user orientation](new-user-orientation.md) completed (or equivalent)
- **Citation Access** (`Rms.Citation.Access`) and **Citation Modify** (`Rms.Citation.Modify`)
- Mobile Modify / Dashboard **Mobile Citations** if practicing SYNCED import
- Sample data: at least one **DRAFT**, one **ISSUED**, and (if available) one **SYNCED** citation

## Agenda

| Block | Minutes | Guide | Exercise |
|-------|--------:|-------|----------|
| Overview | 10 | [Citations overview](../rms/citations/README.md) | Citation vs court violation; DRAFT / ISSUED / SYNCED |
| Search | 15 | [Search](../rms/citations/search.md) | Find a sample citation; note Source + Workflow |
| Add (desktop) | 20 | [Add](../rms/citations/add.md) | Create a draft citation |
...
| Track | Focus |
|-------|--------|
| **Officer** | Add → tabs → certify/issue → print |
| **Records** | Search backlog → SYNCED import → finish → issue coordination |
| **Supervisor** | Review Issued; Reset for Edit policy; no duplicate numbers |
