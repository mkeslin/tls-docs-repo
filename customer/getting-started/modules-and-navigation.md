...
The far-left column is a list of **module icons**. What you see depends on your agency licenses and your user claims — missing icons usually mean you do not have access, not that the product is broken.

Hover or click a module icon to open its **module menu** (the wider panel). From there you typically choose **Search**, **Add**, **Reports**, or other module-specific destinations.

## Common pattern: Search and Add

Most records modules follow the same habit:

1. Open the module from the left rail.
