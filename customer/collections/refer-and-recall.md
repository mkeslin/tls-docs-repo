...
Common blockers (agency/config dependent): indigency rules that suppress TPC, principal/balance rules, unpaid TPC preventing a new TPC — follow your court policy and on-screen warnings.

## Refer a case

1. Open the court violation.
2. Confirm **ELIGIBLE** (or your agency’s batch queue).
...
Agency collections vendor name/contact and auto-refer days are maintained with Thin Line / Admin during implementation — not every clerk should change them.
